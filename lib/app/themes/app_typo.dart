...
class AppTypoW {
  ...
  static TextStyle highlight1 = GoogleFonts.montserrat(
      fontSize: 18.sp, fontWeight: FontWeight.w500, color: Colors.white);
  static TextStyle highlight2 = GoogleFonts.montserrat(
      fontSize: 14.sp, fontWeight: FontWeight.w500, color: Colors.white);
  static TextStyle highlight3 = GoogleFonts.montserrat(
